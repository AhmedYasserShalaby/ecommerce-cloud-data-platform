...
from commerce_platform.dashboard_data import DEFAULT_QUERY, ensure_dashboard_data, executive_kpis, load_export, run_dashboard_query

st.set_page_config(page_title="E-Commerce Data Platform", page_icon="◼", layout="wide")
...
with tabs[2]:
    ...
    if not inventory.empty:
        ...
        st.dataframe(inventory.sort_values(["inventory_risk", "on_hand_units"], ascending=[False, True]).head(75), use_container_width=True)
